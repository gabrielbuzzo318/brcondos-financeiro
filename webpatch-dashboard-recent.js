(function(){
  ...
  function renderRecent(){
    ...
    if(dashboardPanel)dashboardPanel.insertAdjacentElement('afterend',card);
  ...
  if(typeof prevShowView==='function'){
    window.showView=function(view,button){
      ...
      if(view==='dashboard')setTimeout(renderRecent,40);
      return out;
    };
  }

  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',()=>setTimeout(renderRecent,180),{once:true});
  else setTimeout(renderRecent,180);
})();